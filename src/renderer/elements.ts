...
export const mainElem = document.querySelector('main') as HTMLElement;
...
export const menuMoveButton = document.querySelector('#menu .move') as HTMLElement;
...
export const listViewMoveHereButton = document.querySelector('#list-view .move-here') as HTMLButtonElement;
export const listViewCancelMoveButton = document.querySelector('#list-view .cancel-move') as HTMLButtonElement;
...
export const questionContentViewDiv = document.querySelector('#question-content-view') as HTMLElement;
export const questionViewDiv = document.querySelector('#question-view') as HTMLElement;
export const questionViewToggleButton = document.querySelector('#question-view .toggle') as HTMLElement;
